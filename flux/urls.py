...
from .views import Article, TagView, ArticleList, ArticleYearView, ArticleTagView, ArticleList_back, ArticleCount
...
urlpatterns = [
    ...
    #
    # 根据年份统计数据
    path("article/count", ArticleCount.as_view(), name="article_count")
]
